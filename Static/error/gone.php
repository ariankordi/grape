...
<body>
  <h1 id="header">Miiverse</h1>
  <div id="body">
    <h2 class="title" id="error-title-503">Server Error</h2>
    <div id="content" style="">
      <p id="error-code-503">Error Code: 115-5004</p>
      <p id="error-text-503">The Miiverse service has ended.<br>Thank you for using Miiverse.</p>
    </div>
  </div>
  ...
  <script>wiiuErrorViewer.openByCodeAndMessage(1155004, "The Miiverse service has ended.\nMiiverse and any software features\nthat make use of Miiverse will no\nlonger be available.\n\nThank you for your interest.");wiiuBrowser.closeApplication();</script>
</body>
</html>
