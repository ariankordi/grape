...
<head>
  ...
  <style type="text/css">
    ...
    #header {
      ...
      margin: 0;
      padding-left: 40px;
      border-bottom: 2px solid #49A10F;
	  /* 490ea0 for 'grape' theme */
      font-size:28px;
      font-weight:bold;
      text-shadow: 0 -2px 0 rgba(0, 0, 0, 0.2);
      color:#fff;
      background: #5AC800;
	  /* 6700c8 for 'grape' theme */
      background: -webkit-gradient(linear, left top, left bottom, from(#81E52E), to(#5AC800));
	  /* b22eea for 'grape' theme */
    }
    #body {
      width:960px;
      margin:0 auto;
    ...
    #exit-button {
     ...
     display: block;
      ...
      background: url(data:image/png;base64,) no-repeat 36px 32px, -webkit-gradient(linear, left top, left bottom, from(#5A5A5A), to(#242424));
...
<body>
  <h1 id="header">rverse</h1>
  <div id="body">
    <h2 class="title" id="error-title-503">Server Error</h2>
    <div id="content" style="background-image: url(/img/error/error2.png);">
      <p id="error-code-503">Status: 503 (Service Temporarily Unavailable)</p>
      <p id="error-text-503">rverse is currently undergoing maintenance. Please come back later!</p>
    </div>
  </div>
  <a href="#" id="exit-button" onclick="wiiuSound.playSoundByName('SE_WAVE_EXIT', 0x3); wiiuBrowser.jumpToHomeButtonMenu ? wiiuBrowser.jumpToHomeButtonMenu() : wiiuBrowser.closeApplication();">Close</a>
  <script>wiiuBrowser.endStartUp();setTimeout(function(){wiiuSound.playSoundByName('BGM_OLV_SETTING',3);},1000)</script>
  <script>setTimeout(function(){window.location.href="https://rvqcportal.rverse.club/titles/show"},30000);</script>
</body>
</html>
