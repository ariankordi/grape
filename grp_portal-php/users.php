...
$sql_userpage_user = 'SELECT * FROM people WHERE people.user_id = "' . mysqli_real_escape_string($link, $_GET['user_id']) . '"';
$result_userpage_user = mysqli_query($link, $sql_userpage_user);
$row_userpage_user = mysqli_fetch_assoc($result_userpage_user);

if(isset($_SESSION['signed_in'])) {
$sql_userpage_me = 'SELECT * FROM grape.people WHERE people.pid = "' . $_SESSION['pid'] . '"';
$result_userpage_me = mysqli_query($link, $sql_userpage_me);
...
$result_userpage_user_profile = mysqli_query($link, $sql_userpage_user_profile);
...
$result_userpage_user_posts = mysqli_query($link, $sql_userpage_user_posts);

$sql_userpage_user_empathies = 'SELECT * FROM empathies WHERE empathies.pid = "' . $row_userpage_user['pid'] . '"';
$result_userpage_user_empathies = mysqli_query($link, $sql_userpage_user_empathies);

$sql_userpage_user_posts_view = 'SELECT * FROM posts WHERE posts.pid = "' . $row_userpage_user['pid'] . '" ORDER BY posts.created_at DESC LIMIT 50 OFFSET '.mysqli_real_escape_string($link, $_GET['offset']).'';
$result_userpage_user_posts_view = mysqli_query($link, $sql_userpage_user_posts_view);	
...
$result_userpage_user_posts_view_user = mysqli_query($link, $sql_userpage_user_posts_view_user);
...
$result_userpage_user_posts_view_replies = mysqli_query($link, $sql_userpage_user_posts_view_replies);

$sql_userpage_user_posts_view_empathies = 'SELECT * FROM empathies WHERE empathies.id = "' . $row_userpage_user_posts_view['id'] . '"';
$result_userpage_user_posts_view_empathies = mysqli_query($link, $sql_userpage_user_posts_view_empathies);
...
$sql_userpage_user_friends = 'SELECT * FROM grape.friend_relationships WHERE friend_relationships.target = "'.$row_userpage_user['pid'].'" OR friend_relationships.source = "'.$row_userpage_user['pid'].'" ORDER BY friend_relationships.relationship_id LIMIT 100';
$result_userpage_user_friends = mysqli_query($link, $sql_userpage_user_friends);
...
$result_userpage_user_followers = mysqli_query($link, $sql_userpage_user_followers);
...
$result_userpage_user_following = mysqli_query($link, $sql_userpage_user_following);
...
$result_posts_getfavoritepost = mysqli_query($link, 'SELECT * FROM grape.posts WHERE posts.id = "'.mysqli_real_escape_string($link, $row_userpage_user_profile['favorite_screenshot']).'"');
...
$sql_userpage_user_empathies_view = 'SELECT * FROM empathies WHERE empathies.pid = "' . $row_userpage_user['pid'] . '" ORDER BY empathies.created_at DESC LIMIT 20 OFFSET '.mysqli_real_escape_string($link, $_GET['offset']).'';
$result_userpage_user_empathies_view = mysqli_query($link, $sql_userpage_user_empathies_view);
...
$result_userpage_user_empathies_view_posts = mysqli_query($link, $sql_userpage_user_empathies_view_posts); 	
...
$result_userpage_user_empathies_view_postsuser = mysqli_query($link, $sql_userpage_user_empathies_view_postsuser); 
...
$result_userpage_user_empathies_view_postsreplies = mysqli_query($link, $sql_userpage_user_empathies_view_postsreplies);
...
$result_userpage_user_empathies_view_postsempathies = mysqli_query($link, $sql_userpage_user_empathies_view_postsempathies);
...
$result_search_relationships = mysqli_query($link, $sql_search_relationships);
...
$sql_relationships_users = 'SELECT * FROM grape.people WHERE people.pid = "'.$row_search_relationships['target'].'"';
$result_relationships_users = mysqli_query($link, $sql_relationships_users);
...
$sql_relationships_users = 'SELECT * FROM grape.people WHERE people.pid = "'.$row_search_relationships['source'].'"';
$result_relationships_users = mysqli_query($link, $sql_relationships_users);
$row_relationships_users = mysqli_fetch_assoc($result_relationships_users);
...
$sql_search_friend_relationships = 'SELECT * FROM grape.friend_relationships WHERE friend_relationships.target = "'.$row_userpage_user['pid'].'" OR friend_relationships.source = "'.$row_userpage_user['pid'].'" ORDER BY friend_relationships.relationship_id DESC LIMIT 100';
$result_search_friend_relationships = mysqli_query($link, $sql_search_friend_relationships);
...
$sql_search_friend_relationships1 = 'SELECT * FROM grape.people WHERE people.pid = "'.($row_search_friend_relationships['source'] == $row_userpage_user['pid'] ? $row_search_friend_relationships['target'] : $row_search_friend_relationships['source']).'"';
$result_search_friend_relationships1 = mysqli_query($link, $sql_search_friend_relationships1);
...
$sql_search_friend_request = 'SELECT * FROM grape.friend_requests WHERE friend_requests.sender = "'.$row_userpage_user['pid'].'" AND friend_requests.finished = "0" ORDER BY created_at DESC';
$result_search_friend_request = mysqli_query($link, $sql_search_friend_request);
...
$sql_relationships_users = 'SELECT * FROM grape.people WHERE people.pid = "'.$row_search_friend_request['recipient'].'"';
$result_relationships_users = mysqli_query($link, $sql_relationships_users);
$row_relationships_users = mysqli_fetch_assoc($result_relationships_users);
...
include 'communities-showfavorites.php';
}
else {
$pagetitle = 'Error';
include 'lib/header.php';
...
$sql_post_getotheruser = 'SELECT * FROM grape.people WHERE people.pid = "' . mysqli_real_escape_string($link, $_GET['user_id']) . '"';
$result_post_getotheruser = mysqli_query($link, $sql_post_getotheruser);
...
$sql_userwho = 'SELECT * FROM people WHERE people.user_id = "' . mysqli_real_escape_string($link, $_GET['user_id']) . '"';
$result_userwho = mysqli_query($link, $sql_userwho);
...
$result_search_relationship2 = mysqli_query($link, $sql_search_relationship2);
...
$sql_post_getuforfollow = 'SELECT * FROM grape.people WHERE people.user_id = "' . mysqli_real_escape_string($link, $_GET['user_id']) . '"';
$result_post_getuforfollow = mysqli_query($link, $sql_post_getuforfollow);
$row_post_getuforfollow = mysqli_fetch_assoc($result_post_getuforfollow); 
// User checks over. Is eligible to follow.
        $sql_relationshipcreate = 'INSERT INTO grape.relationships(source, target) VALUES ("' . $_SESSION['pid'] . '", "' . $row_post_getuforfollow['pid'] . '")';
		$sql_newscreate = 'INSERT INTO grape.news(from_pid, to_pid, news_context, has_read) VALUES ("'.$_SESSION['pid'].'", "'.$row_post_getuforfollow['pid'].'", "6", "0")';
	...
	$result_check_fastnews = mysqli_query($link, 'SELECT news.to_pid, news.created_at FROM grape.news WHERE news.from_pid = "'.$_SESSION['pid'].'" AND news.to_pid = "'.$row_post_getuforfollow['pid'].'" AND news.news_context = "6" AND news.created_at > NOW() - 8 ORDER BY news.created_at DESC');
    if(mysqli_num_rows($result_check_fastnews) == 0) {
    $result_check_ownusernews = mysqli_query($link, 'SELECT * FROM news WHERE news.from_pid = "'.$_SESSION['pid'].'" AND news.to_pid = "'.$row_post_getuforfollow['pid'].'" AND news.created_at > NOW() - 7200 ORDER BY news.created_at DESC');
$row_check_ownusernews = mysqli_fetch_assoc($result_check_ownusernews);
	$result_check_mergedusernews = mysqli_query($link, 'SELECT * FROM news WHERE news.from_pid = "'.$_SESSION['pid'].'" AND news.to_pid = "'.$row_post_getuforfollow['pid'].'" AND news.merged IS NOT NULL AND news.created_at > NOW() - 7200 ORDER BY news.created_at DESC');
 if(mysqli_num_rows($result_check_mergedusernews) != 0) {
	...
	$result_update_newsmergesearch = mysqli_query($link, 'SELECT * FROM news WHERE news.to_pid = "'.$row_post_getuforfollow['pid'].'" AND news.news_context = "6" AND news.created_at > NOW() - 7200 ORDER BY news.created_at DESC');
...
$row_update_newsmergesearch = mysqli_fetch_assoc($result_update_newsmergesearch);
	...
	$result_newscreatemerge = mysqli_query($link, 'INSERT INTO grape.news(from_pid, to_pid, merged, news_context, has_read) VALUES ("'.$_SESSION['pid'].'", "'.$row_post_getuforfollow['pid'].'", "'.$row_update_newsmergesearch['news_id'].'", "6", "0")');
$result_update_newsformerge = mysqli_query($link, 'UPDATE news SET has_read = "0", created_at = NOW() WHERE news.news_id = "'.$row_update_newsmergesearch['news_id'].'"');
        ...
        $result_newscreate = mysqli_query($link, 'INSERT INTO grape.news(from_pid, to_pid, news_context, has_read) VALUES ("'.$_SESSION['pid'].'", "'.$row_post_getuforfollow['pid'].'", "6", "0")'); 	
	} }
...
print "\n";
        ...
        {
$sql_my_followingcount = 'SELECT * FROM grape.relationships WHERE relationships.source = '.$_SESSION['pid'].'';
$result_my_followingcount = mysqli_query($link, $sql_my_followingcount);
header('Content-Type: application/json; charset=utf-8');
...
$result_search_relationship = mysqli_query($link, $sql_search_relationship);
...
// User checks over. Is eligible to follow.
        ...
        $result_relationshipdelete = mysqli_query($link, $sql_relationshipdelete);
...
$sql_search_friend_request = 'SELECT * FROM grape.friend_requests WHERE friend_requests.sender = "'.$row_userpage_me['pid'].'" AND friend_requests.recipient = "'.$row_userpage_user['pid'].'" AND friend_requests.finished = "0"';
$result_search_friend_request = mysqli_query($link, $sql_search_friend_request);
...
if(mysqli_num_rows(mysqli_query($link, 'SELECT * FROM grape.friend_requests WHERE friend_requests.sender = "'.$row_userpage_me['pid'].'" AND friend_requests.recipient = "'.$row_userpage_user['pid'].'" AND friend_requests.finished = "0"')) == 0 && mysqli_num_rows(mysqli_query($link, 'SELECT * FROM grape.friend_relationships WHERE friend_relationships.source = "'.$row_userpage_me['pid'].'" AND friend_relationships.target = "'.$row_userpage_user['pid'].'" OR friend_relationships.source = "'.$row_userpage_user['pid'].'" AND friend_relationships.target = "'.$row_userpage_me['pid'].'"')) == 0) {
print '
<div class="button-with-option dropdown">
...
if(mysqli_num_rows($result_search_friend_request) <= 0) {
$sql_friend_relationship = 'SELECT * FROM grape.friend_relationships WHERE friend_relationships.source = "'.$row_userpage_me['pid'].'" AND friend_relationships.target = "'.$row_userpage_user['pid'].'" OR friend_relationships.source = "'.$row_userpage_user['pid'].'" AND friend_relationships.target = "'.$row_userpage_me['pid'].'"';
...
print '<div class="favorite-communities scroll">
  ...
  ';
$get_user_favorite_communities = mysqli_fetch_all(mysqli_query($link, 'select a.*, bm.* from (select * from communities group by community_id) bm inner join favorites a on bm.community_id = a.community_id WHERE a.pid = "'.$row_userpage_user['pid'].'" ORDER BY a.created_at DESC'), MYSQLI_ASSOC);
